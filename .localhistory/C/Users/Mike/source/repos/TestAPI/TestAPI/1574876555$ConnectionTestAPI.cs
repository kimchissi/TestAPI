...
namespace TestAPI
{
    public class DBConnectTestAPI
    {
        //public String SqlConnectString { get; set; }

        String SqlConnectString = "server=cis-mssql1.temple.edu;Database=fa19_3344_tug910455;User id=tug91045;Password=ShuY4yoo";
        SqlConnection myConnectionSql;
        SqlCommand objCmd;
        SqlDataReader objDataReader;
        DataSet ds;

        public DBConnectTestAPI()
        {
